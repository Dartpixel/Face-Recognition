...
image1 = face_recognition.load_image_file(os.path.abspath("images/mypic.jpg"))
image1_face_encoding = face_recognition.face_encodings(image1)(0)

image2 = face_recognition.load_image_file(
    os.path.abspath("images/thomas_shelby.png"))
...
while True:
    ...
    print("Face detected -- {}".format(fac_names))
    for (top, right, bottom, left), name in zip(face_locations, face_names):
        ...
        cv2.rectangle(frame, name, (left + 6, bottom - 6),
